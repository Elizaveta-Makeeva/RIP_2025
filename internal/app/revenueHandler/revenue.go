...
func (h *RevenueHandler) RegisterRevenueHandler(router *gin.Engine) {
	...
	router.GET("/application/:id", h.GetPeriodsApplication)
	router.GET("/draft-application", h.GetOrCreateDraftApplication)
	router.POST("/add-to-application/:id", h.AddPeriodToApplicationForm)
	router.POST("/delete-application/:id", h.DeleteApplication)
}
...
func (h *RevenueHandler) GetOrCreateDraftApplication(ctx *gin.Context) {
	...
	application, err := h.RevenueModel.GetOrCreateDraftApplication(userID)
	if err != nil {
		logrus.Error("error", err)
	}
...
func (h *RevenueHandler) AddPeriodToApplicationForm(ctx *gin.Context) {
	...
	err = h.RevenueModel.AddPeriodToApplication(application.ID, periodID)
...
func (h *RevenueHandler) DeleteApplication(ctx *gin.Context) {
	...
	err = h.RevenueModel.DeleteApplication(applicationID)
    if err != nil {
        logrus.Error("error", err)
    }
